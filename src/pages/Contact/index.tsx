    ...
    <>
            ...
            <div className="col-lg-6">
              <div className="pr--75 pr_lg--0 pr_md--0 pr_sm--0">
                <div className="thumbnail">
                  <img className="w-100" src="/images/contact/contact-1.jpg" alt="Contact Me" />
      ...
      <div className="eduvibe-contact-me-bottom edu-contact-address contact-address-bottom-shape edu-section-gapBottom">
          ...
          <div className="row g-5 mt--20">
            <div className="col-lg-4 col-md-6">
              <div className="contact-address-card-2">
                <div className="inner">
                  <div className="icon">
                    <img src="/images/contact/whatsapp.png" alt="Icon Images" />
                  </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="contact-address-card-2">
                <div className="inner">
                  <div className="icon">
                    <img src="/images/contact/house.png" alt="Icon Images" />
                  </div>
                  <div className="content">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="contact-address-card-2">
                <div className="inner">
                  <div className="icon">
                    <img src="/images/contact/linkedin.png" alt="Icon Images" />
                  </div>
                  <div className="content">
        ...
        <div className="bg-shape-image">
          <img src="/images/bg/contact.jpg" alt="Shape Images" />
        </div>
      </div>
    </>
  )
