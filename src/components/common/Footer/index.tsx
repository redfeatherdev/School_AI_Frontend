                ...
                <div className="edu-footer-widget explore-widget">
                  ...
                  <div className="inner">
                    <ul className="footer-link link-hover">
                      ...
                      <li><Link to="/blog"><i className="icon-Double-arrow"></i>Blog & News</Link></li>
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="inner text-center">
                  <p>Copyright 2024 <a href="#">School AI</a> Designed By <a href="https://themeforest.net/user/devsvibe">DevsAlpha</a>. All Rights
                    Reserved</p>
                </div>
              </div>
            </div>
