              ...
              <div className="edu-instructor">
                <div className="inner">
                  <div className="thumbnail">
                    <Link to={`/instructor-details/${slugify('James Carlson')}`}>
                      <img src="/images/instructor/instructor-1.jpg" alt="team images" />
                    </Link>
                  </div>
                  <div className="edu-instructor-info">
                    <h5 className="title"><Link to={`/instructor-details/${slugify('James Carlson')}`}>James Carlson</Link></h5>
          ...
          <div className="col-lg-3 col-md-6 col-sm-6 col-12">
            <div className={`edu-instructor-grid edu-instructor-3 edu-instructor-3-visible${visible === 'team2' ? ' eduvibe-hover-active' : ''}`} onMouseOver={() => setVisible('team2')}>
              <div className="edu-instructor">
                <div className="inner">
                  <div className="thumbnail">
                    <Link to={`/instructor-details/${slugify('Nancy Phipps')}`}>
                      <img src="/images/instructor/instructor-2.jpg" alt="team images" />
                    </Link>
                  </div>
                  <div className="edu-instructor-info">
                    <h5 className="title"><Link to={`/instructor-details/${slugify('Nancy Phipps')}`}>Nancy Phipps</Link></h5>
          ...
          <div className="col-lg-3 col-md-6 col-sm-6 col-12">
            <div className={`edu-instructor-grid edu-instructor-3 edu-instructor-3-visible${visible === 'team3' ? ' eduvibe-hover-active' : ''}`} onMouseOver={() => setVisible('team3')}>
              <div className="edu-instructor">
                <div className="inner">
                  <div className="thumbnail">
                    <Link to={`/instructor-details/${slugify('Troy Hall')}`}>
                      <img src="/images/instructor/instructor-3.jpg" alt="team images" />
                    </Link>
                  </div>
                  <div className="edu-instructor-info">
                    <h5 className="title"><Link to={`/instructor-details/${slugify('Troy Hall')}`}>Troy Hall</Link></h5>
          ...
          <div className="col-lg-3 col-md-6 col-sm-6 col-12">
            <div className={`edu-instructor-grid edu-instructor-3 edu-instructor-3-visible${visible === 'team4' ? ' eduvibe-hover-active' : ''}`} onMouseOver={() => setVisible('team4')}>
              <div className="edu-instructor">
                <div className="inner">
                  <div className="thumbnail">
                    <Link to={`/instructor-details/${slugify('Isabelle Bruner')}`}>
                      <img src="/images/instructor/instructor-4.jpg" alt="team images" />
                    </Link>
                  </div>
                  <div className="edu-instructor-info">
                    <h5 className="title"><Link to={`/instructor-details/${slugify('Isabelle Bruner')}`}>Isabelle Bruner</Link></h5>
