...
import InstructorData from 'data/instructor_data.json';

const Item = ({ data, classes }: {
  data: any,
  classes?: string
}) => {
      ...
      <div className="inner">
        <div className="thumbnail">
          <Link to={`/course-details/${data.id}`}>
            <img className="w-100" src={`/images/course/${data.image}`} alt="Course Thumb" />
          </Link>
          ...
          <div className="card-top">
            <div className="author-meta">
              <div className="author-thumb">
                <Link to={`/instructor-details/${slugify(data.instructor)}`}>
                  {/* <img src={`/images/instructor/instructor-small/${instructorThumb}`} alt="Author Thumb" /> */}
