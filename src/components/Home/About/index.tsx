        ...
        <div className="row g-5">
          <div className="col-lg-6">
            <div className="about-image-gallery">
              <img className="image-1" src="/images/about/about-image-01.jpg" alt="About Main Thumb" />
              <div className="image-2">
                <img src="/images/about/about-image-02.jpg" alt="About Parallax Thumb" />
              </div>
              <div className="badge-inner">
                <img className="image-3" src="/images/about/badge.png" alt="About Circle Thumb" />
              </div>
          ...
          <div className="col-lg-6">
            <div className="inner">
              ...
              <ScrollAnimation
                ...
                animateOnce={true}
              >
                <Link className="btn" to="/about-us">Know About Us<i className="icon-arrow-right-line-right"></i></Link>
              </ScrollAnimation>
