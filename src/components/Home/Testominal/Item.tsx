...
const TestimonialOne: React.FC<{ className?: string; item?: number; quoteIcon?: string }> = (props) => {
          ...
          <div className="inner">
            {props.quoteIcon !== 'disable' &&
              <div className="quote-sign">
                <img src="/images/testimonial/quote.png" alt="Quote Images" />
              </div>
            }
            <p className="description">“ {item.details}”</p>
            <div className="client-information">
              <div className="thumb">
                <img src={`/images/testimonial/${item.image}`} alt="Client Thumb" />
              </div>
              <div className="info">
